...
from typing import Optional, AsyncIterator, Iterator, Dict
...
class AsyncNATSResultStorage(BaseResultStorage):
    ...
    async def get_result_async(self, task_id: uuid.UUID) -> Optional[TaskResult]:
        ...
        try:
            ...
            if msg:
                ...
                result_data_decoded = (
                    json.loads(result_data["result_data"])
    ...
    async def get_results_by_status_async(
        self, status: str
...
# Alias for consistency with other result storage implementations
AsyncNatsResultStorage = AsyncNATSResultStorage
NatsResultStorage = NATSResultStorage
