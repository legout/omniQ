# src/omniq/queue/memory.py
"""Memory task queue implementation for OmniQ."""
...
class MemoryTaskQueue(BaseTaskQueue):
    """Task queue implementation using fsspec MemoryFileSystem."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize a memory task queue.
    ...
    def _get_queue_path(self, queue_name: str) -> str:
        ...
        return os.path.join(self.project_name, "queues", queue_name)
    ...
    # The rest of the implementation follows the same pattern as FileTaskQueue
